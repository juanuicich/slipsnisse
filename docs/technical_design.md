...
The behaviour is driven entirely by a JSON configuration file.
  ...
  "tools": [
    {
      ...
      "system_prompt": "You are a Rust expert. Search docs, read files to check compatibility, and synthesise an answer."
    }
  ]
}
```
...
* **Eager Initialisation:** All downstream MCPs are spawned at startup.
...
* Initialise the Slipsnisse `McpServer`.
